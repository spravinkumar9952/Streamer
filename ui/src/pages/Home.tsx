...
import { Friend, FrinedsListResp, getFriendsList } from "../api/profile";
...
const Home : FC = () => {
  ...
  const [friends, setFriends] = useState < FrinedsListResp | null>(null);
  ...
  return (
    <div className="bg-primaryBG">
      <NavBar onSearchTextChange={onSearchTextChange} />
        ...
        <div className="flex flex-row w-2/3 justify-around mt-36 mb-3">
          ...
          {selectedSection === Section.Friends 
            ...
            <>
              ...
              {friends?.friendRequests.map(item => <FriendItemView friend={item}/>)}
              </>
...
const FriendItemView: FC<FriendItemViewProps> = ({ friend }) => {
  return (
    <div className = "w-2/3 bg-secondaryBG flex flex-row justify-start p-5 mx-2 rounded-lg items-center" >
      <img src="/png/users.png" alt="users" className="w-11 h-11"/>
